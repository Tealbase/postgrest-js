...
CREATE PUBLICATION tealbase_realtime FOR ALL TABLES;
...
ALTER TABLE public.users REPLICA IDENTITY FULL; -- Send "previous data" to tealbase
...
ALTER TABLE public.messages REPLICA IDENTITY FULL; -- Send "previous data" to tealbase
