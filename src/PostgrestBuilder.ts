// @ts-ignore
import nodeFetch from '@tealbase/node-fetch'
    ...
    >
{
   ...
   *
   * {@link https://github.com/tealbase/tealbase-js/issues/92}
   */
  ...
  >(
    ...
    // https://github.com/tealbase/postgrest-js/pull/247
    ...
    let res = _fetch(this.url.toString(), {
      ...
      if (res.ok) {
        ...
        // Temporary partial fix for https://github.com/tealbase/postgrest-js/issues/361
        ...
        try {
          ...
          // Workaround for https://github.com/tealbase/postgrest-js/issues/295
   ...
   * const query = tealbase
   *   .from('users')
   *   .select()
   *   .overrideTypes<{ custom_field: string }>()
   *
   * // Replace existing types completely
   * const replaceQuery = tealbase
   *   .from('users')
   *   .select()
